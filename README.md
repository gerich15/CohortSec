...
<img width="1920" height="963" alt="Снимок экрана от 2026-02-23 21-44-38" src="https://github.com/user-attachments/assets/ff53b7af-a652-4d86-962a-7d27fd8d19e1" />
...
| **Telegram-бот** | Проверка номеров, паролей, ссылок, никнеймов; настройки уведомлений (push, новости, лайфхаки); важные алерты (подозрительная активность, взлом) нельзя отключить |

Дополнительно: MFA (TOTP), вход по лицу (биометрия), чат поддержки, юридические разделы (политика конфиденциальности, cookie, EULA).

<img width="1920" height="963" alt="Снимок экрана от 2026-02-23 21-44-50" src="https://github.com/user-attachments/assets/e08af143-94bf-4ad5-91eb-f373a6875f71" />
<img width="1920" height="963" alt="Снимок экрана от 2026-02-23 21-45-02" src="https://github.com/user-attachments/assets/a4ed3ac8-4777-4bbe-aa62-f164cf4b1b9b" />
