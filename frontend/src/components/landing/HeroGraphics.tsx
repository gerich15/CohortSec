export function HeroShield() {
  return (
    <div className="hero-shield absolute left-0 top-0 h-[100vh] w-[50vw] overflow-hidden pointer-events-none">
      <div
...
export function HeroBug() {
  return (
    <div className="hero-bug absolute right-0 top-0 h-[100vh] w-[50vw] overflow-hidden pointer-events-none">
      <div
